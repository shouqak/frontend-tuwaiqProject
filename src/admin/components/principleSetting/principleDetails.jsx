...
const PrincipleDetails = () => {
  ...
  const update = async () => {
    try {
      ...
      console.error("Error updating Principle details:", error);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex flex-col items-start gap-8 shadow-lg rounded-lg bg-white p-6 w-full max-w-lg">
        ...
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="flex items-center justify-center w-full gap-4 mt-4">
            ...
            <button
              onClick={() => navigate("/admin/readPrinciple")}
