...
function CreateNewAdmin () {
  ...
  const [emailErr, setEmailErr] = useState(
    "Enter a valid email that includes (@admin.tuwaiq.sa)"
  );
  ...
  const register = async () => {
    ...
    } else if (!email.includes("admin.tuwaiq.sa")) {
      isValid = false;
      toast.error("Email must include @admin.tuwaiq.sa");
    }
    ...
    <div className="min-h-screen min-w-screen flex justify-center items-center">
      <div className=" flex items-center gap-7 shadow-2xl rounded-2xl bg-gray-100">
        <div className="flex flex-col justify-start p-3">
          ...
          <p className="text-lg font-medium "><b>Admin</b> Register</p>
        </div>
